...
const UserReservas = () => {
  ...
  const guardarReserva = async (nuevaReserva) => {
    // Verificar duplicado en la misma fecha (sin importar hora)
  ...
  const getRecursosDisponibles = (tipo) => {
    ...
    const stored = localStorage.getItem("afterdark_reservas");
    const todas = stored ? JSON.parse(stored) : [];
    // Filtrar reservas para la fecha seleccionada y que no estén canceladas
    const reservasEnFecha = todas.filter(
      (r) => r.fecha === form.fecha && r.estado !== "Cancelado"
    );
    // IDs de recursos ocupados en esa fecha (sin importar hora)
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
            <aside className="lg:col-span-4 flex flex-col gap-gutter">
              ...
              <div className="glass-panel rounded-xl p-md space-y-4">
            ...
            <section className="lg:col-span-8 flex flex-col gap-gutter">
              <div className="glass-panel rounded-xl p-md overflow-hidden relative min-h-[400px] flex flex-col">
      ...
      <style jsx>{`
        ...
        .glass-panel { background: rgba(28,28,30,0.7); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.1); }
